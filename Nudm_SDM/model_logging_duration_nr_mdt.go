...
func (v *LoggingDurationNrMdt) UnmarshalJSON(src []byte) error {
	...
	for _, existing := range AllowedLoggingDurationNrMdtEnumValues {
	...
	return fmt.Errorf("%+v is not a valid LoggingDurationNrMdt", value)
}
...
func NewLoggingDurationNrMdtFromValue(v string) (*LoggingDurationNrMdt, error) {
	...
	if ev.IsValid() {
		...
		return nil, fmt.Errorf("invalid value '%v' for LoggingDurationNrMdt: valid values are %v", v, AllowedLoggingDurationNrMdtEnumValues)
	}
}
