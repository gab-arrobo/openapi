...
func (a *GPSIToSUPITranslationOrSUPIToGPSITranslationAPIService) GetSupiOrGpsiExecute(r ApiGetSupiOrGpsiRequest) (*IdTranslationResult, *http.Response, error) {
	...
	if r.afId != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "af-id", r.afId, "form", "")
	}
	if r.appPortId != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "app-port-id", r.appPortId, "", "")
	}
	if r.afServiceId != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "af-service-id", r.afServiceId, "form", "")
	}
	if r.mtcProviderInfo != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "mtc-provider-info", r.mtcProviderInfo, "form", "")
	}
	if r.requestedGpsiType != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "requested-gpsi-type", r.requestedGpsiType, "form", "")
	}
