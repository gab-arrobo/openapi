...
func (v *ReportingTrigger) UnmarshalJSON(src []byte) error {
	...
	for _, existing := range AllowedReportingTriggerEnumValues {
	...
	return fmt.Errorf("%+v is not a valid ReportingTrigger", value)
}
...
func NewReportingTriggerFromValue(v string) (*ReportingTrigger, error) {
	...
	if ev.IsValid() {
		...
		return nil, fmt.Errorf("invalid value '%v' for ReportingTrigger: valid values are %v", v, AllowedReportingTriggerEnumValues)
	}
}
