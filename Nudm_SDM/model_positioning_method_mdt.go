...
func (v *PositioningMethodMdt) UnmarshalJSON(src []byte) error {
	...
	for _, existing := range AllowedPositioningMethodMdtEnumValues {
	...
	return fmt.Errorf("%+v is not a valid PositioningMethodMdt", value)
}
...
func NewPositioningMethodMdtFromValue(v string) (*PositioningMethodMdt, error) {
	...
	if ev.IsValid() {
		...
		return nil, fmt.Errorf("invalid value '%v' for PositioningMethodMdt: valid values are %v", v, AllowedPositioningMethodMdtEnumValues)
	}
}
