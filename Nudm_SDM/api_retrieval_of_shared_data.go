...
func (a *RetrievalOfSharedDataAPIService) GetSharedDataExecute(r ApiGetSharedDataRequest) ([]SharedData, *http.Response, error) {
	...
	parameterAddToHeaderOrQuery(localVarQueryParams, "shared-data-ids", r.sharedDataIds, "form", "csv")
	if r.supportedFeatures != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "supportedFeatures", r.supportedFeatures, "form", "")
	}
	if r.supportedFeatures2 != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "supported-features", r.supportedFeatures2, "form", "")
	}
