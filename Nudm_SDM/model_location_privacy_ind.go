...
func (v *LocationPrivacyInd) UnmarshalJSON(src []byte) error {
	...
	for _, existing := range AllowedLocationPrivacyIndEnumValues {
	...
	return fmt.Errorf("%+v is not a valid LocationPrivacyInd", value)
}
...
func NewLocationPrivacyIndFromValue(v string) (*LocationPrivacyInd, error) {
	...
	if ev.IsValid() {
		...
		return nil, fmt.Errorf("invalid value '%v' for LocationPrivacyInd: valid values are %v", v, AllowedLocationPrivacyIndEnumValues)
	}
}
