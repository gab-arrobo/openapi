...
func (a *GroupIdentifiersAPIService) GetGroupIdentifiersExecute(r ApiGetGroupIdentifiersRequest) (*GroupIdentifiers, *http.Response, error) {
	...
	if r.extGroupId != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "ext-group-id", r.extGroupId, "form", "")
	}
	if r.intGroupId != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "int-group-id", r.intGroupId, "form", "")
	}
	if r.ueIdInd != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "ue-id-ind", r.ueIdInd, "form", "")
	} else {
