...
type _AccessAndMobilitySubscriptionData AccessAndMobilitySubscriptionData
...
func (o *AccessAndMobilitySubscriptionData) GetNcrOperationAllowed() bool {
	if o == nil || IsNil(o.NcrOperationAllowed) {
		var ret bool
		return ret
	}
...
func (o AccessAndMobilitySubscriptionData) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.AdjacentPlmnMdtUserConsents) {
	...
	if !IsNil(o.NcrOperationAllowed) {
