...
func (a *RetrievalOfMultipleDataSetsAPIService) GetDataSetsExecute(r ApiGetDataSetsRequest) (*SubscriptionDataSets, *http.Response, error) {
	...
	parameterAddToHeaderOrQuery(localVarQueryParams, "dataset-names", r.datasetNames, "form", "csv")
	if r.plmnId != nil {
	...
	if r.ucPurpose != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "uc-purpose", r.ucPurpose, "form", "")
	}
	if r.disasterRoamingInd != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "disaster-roaming-ind", r.disasterRoamingInd, "form", "")
	} else {
