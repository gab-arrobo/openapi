...
type NotificationData struct {
	...
	CompleteNfProfile    NullableNFProfile    `json:"completeNfProfile,omitempty"`
...
func (o *NotificationData) GetSharedDataChanges() []ChangeItem {
	if o == nil || IsNil(o.SharedDataChanges) {
		var ret []ChangeItem
		return ret
	}
...
func (o *NotificationData) GetCompleteNfProfile() NFProfile {
	if o == nil || IsNil(o.CompleteNfProfile.Get()) {
		var ret NFProfile
		return ret
	}
