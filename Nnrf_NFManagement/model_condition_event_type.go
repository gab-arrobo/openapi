...
func (v *ConditionEventType) UnmarshalJSON(src []byte) error {
	...
	for _, existing := range AllowedConditionEventTypeEnumValues {
	...
	return fmt.Errorf("%+v is not a valid ConditionEventType", value)
}
...
func NewConditionEventTypeFromValue(v string) (*ConditionEventType, error) {
	...
	if ev.IsValid() {
		...
		return nil, fmt.Errorf("invalid value '%v' for ConditionEventType: valid values are %v", v, AllowedConditionEventTypeEnumValues)
	}
}
