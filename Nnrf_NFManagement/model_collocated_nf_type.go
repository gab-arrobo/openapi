...
func (v *CollocatedNfType) UnmarshalJSON(src []byte) error {
	...
	for _, existing := range AllowedCollocatedNfTypeEnumValues {
	...
	return fmt.Errorf("%+v is not a valid CollocatedNfType", value)
}
...
func NewCollocatedNfTypeFromValue(v string) (*CollocatedNfType, error) {
	...
	if ev.IsValid() {
		...
		return nil, fmt.Errorf("invalid value '%v' for CollocatedNfType: valid values are %v", v, AllowedCollocatedNfTypeEnumValues)
	}
}
