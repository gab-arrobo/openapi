...
func (dst *SubscrCond) UnmarshalJSON(data []byte) error {
	...
	err = json.Unmarshal(data, &dst.AmfCond)
	if err == nil {
	...
	err = json.Unmarshal(data, &dst.DccfCond)
	if err == nil {
	...
	err = json.Unmarshal(data, &dst.GuamiListCond)
	if err == nil {
	...
	err = json.Unmarshal(data, &dst.NefCond)
	if err == nil {
	...
	err = json.Unmarshal(data, &dst.NetworkSliceCond)
	if err == nil {
	...
	err = json.Unmarshal(data, &dst.NfGroupCond)
	if err == nil {
	...
	err = json.Unmarshal(data, &dst.NfGroupListCond)
	if err == nil {
	...
	err = json.Unmarshal(data, &dst.NfInstanceIdCond)
	if err == nil {
	...
	err = json.Unmarshal(data, &dst.NfInstanceIdListCond)
	if err == nil {
	...
	err = json.Unmarshal(data, &dst.NfServiceSetCond)
	if err == nil {
	...
	err = json.Unmarshal(data, &dst.NfSetCond)
	if err == nil {
	...
	err = json.Unmarshal(data, &dst.NfTypeCond)
	if err == nil {
	...
	err = json.Unmarshal(data, &dst.NwdafCond)
	if err == nil {
	...
	err = json.Unmarshal(data, &dst.ScpDomainCond)
	if err == nil {
	...
	err = json.Unmarshal(data, &dst.ServiceNameCond)
	if err == nil {
	...
	err = json.Unmarshal(data, &dst.ServiceNameListCond)
	if err == nil {
	...
	err = json.Unmarshal(data, &dst.UpfCond)
	if err == nil {
