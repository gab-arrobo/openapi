...
func (v *NoProfileMatchReason) UnmarshalJSON(src []byte) error {
	...
	for _, existing := range AllowedNoProfileMatchReasonEnumValues {
	...
	return fmt.Errorf("%+v is not a valid NoProfileMatchReason", value)
}
...
func NewNoProfileMatchReasonFromValue(v string) (*NoProfileMatchReason, error) {
	...
	if ev.IsValid() {
		...
		return nil, fmt.Errorf("invalid value '%v' for NoProfileMatchReason: valid values are %v", v, AllowedNoProfileMatchReasonEnumValues)
	}
}
