...
func (v *RoamingIndication) UnmarshalJSON(src []byte) error {
	...
	for _, existing := range AllowedRoamingIndicationEnumValues {
	...
	return fmt.Errorf("%+v is not a valid RoamingIndication", value)
}
...
func NewRoamingIndicationFromValue(v string) (*RoamingIndication, error) {
	...
	if ev.IsValid() {
		...
		return nil, fmt.Errorf("invalid value '%v' for RoamingIndication: valid values are %v", v, AllowedRoamingIndicationEnumValues)
	}
}
