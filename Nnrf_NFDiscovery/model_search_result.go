...
func NewSearchResult(validityPeriod int32, nfInstances []NFProfile) *SearchResult {
	this := SearchResult{}
...
func (o *SearchResult) GetSearchResultInfo() SearchResultInfo {
	if o == nil || IsNil(o.SearchResultInfo) {
...
func (o *SearchResult) GetIgnoredQueryParams() []string {
	if o == nil || IsNil(o.IgnoredQueryParams) {
		var ret []string
		return ret
	}
