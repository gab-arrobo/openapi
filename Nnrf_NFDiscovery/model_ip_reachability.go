...
func (v *IpReachability) UnmarshalJSON(src []byte) error {
	...
	for _, existing := range AllowedIpReachabilityEnumValues {
	...
	return fmt.Errorf("%+v is not a valid IpReachability", value)
}
...
func NewIpReachabilityFromValue(v string) (*IpReachability, error) {
	...
	if ev.IsValid() {
		...
		return nil, fmt.Errorf("invalid value '%v' for IpReachability: valid values are %v", v, AllowedIpReachabilityEnumValues)
	}
}
