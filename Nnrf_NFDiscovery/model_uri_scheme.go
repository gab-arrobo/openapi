...
func (v *UriScheme) UnmarshalJSON(src []byte) error {
	...
	for _, existing := range AllowedUriSchemeEnumValues {
	...
	return fmt.Errorf("%+v is not a valid UriScheme", value)
}
...
func NewUriSchemeFromValue(v string) (*UriScheme, error) {
	...
	if ev.IsValid() {
		...
		return nil, fmt.Errorf("invalid value '%v' for UriScheme: valid values are %v", v, AllowedUriSchemeEnumValues)
	}
}
