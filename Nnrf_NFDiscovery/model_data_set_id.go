...
func (v *DataSetId) UnmarshalJSON(src []byte) error {
	...
	for _, existing := range AllowedDataSetIdEnumValues {
	...
	return fmt.Errorf("%+v is not a valid DataSetId", value)
}
...
func NewDataSetIdFromValue(v string) (*DataSetId, error) {
	...
	if ev.IsValid() {
		...
		return nil, fmt.Errorf("invalid value '%v' for DataSetId: valid values are %v", v, AllowedDataSetIdEnumValues)
	}
}
