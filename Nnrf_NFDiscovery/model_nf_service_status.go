...
func (v *NFServiceStatus) UnmarshalJSON(src []byte) error {
	...
	for _, existing := range AllowedNFServiceStatusEnumValues {
	...
	return fmt.Errorf("%+v is not a valid NFServiceStatus", value)
}
...
func NewNFServiceStatusFromValue(v string) (*NFServiceStatus, error) {
	...
	if ev.IsValid() {
		...
		return nil, fmt.Errorf("invalid value '%v' for NFServiceStatus: valid values are %v", v, AllowedNFServiceStatusEnumValues)
	}
}
