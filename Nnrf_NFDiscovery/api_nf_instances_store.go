...
func (r ApiSearchNFInstancesRequest) AdditionalSnssais(additionalSnssais []ExtSnssai) ApiSearchNFInstancesRequest {
...
func (r ApiSearchNFInstancesRequest) UpfEventList(upfEventList []EventType) ApiSearchNFInstancesRequest {
...
func (r ApiSearchNFInstancesRequest) UpfSelectEpdgInfo(upfSelectEpdgInfo EpdgInfo) ApiSearchNFInstancesRequest {
...
func (r ApiSearchNFInstancesRequest) PruTai(pruTai Tai) ApiSearchNFInstancesRequest {
	r.pruTai = &pruTai
	return r
}
...
func (r ApiSearchNFInstancesRequest) AfData(afData AfData) ApiSearchNFInstancesRequest {
	r.afData = &afData
	return r
}
...
func (r ApiSearchNFInstancesRequest) A2xCapability(a2xCapability A2xCapability) ApiSearchNFInstancesRequest {
...
func (a *NFInstancesStoreAPIService) SearchNFInstancesExecute(r ApiSearchNFInstancesRequest) (*SearchResult, *http.Response, error) {
	...
	parameterAddToHeaderOrQuery(localVarQueryParams, "target-nf-type", r.targetNfType, "form", "")
	parameterAddToHeaderOrQuery(localVarQueryParams, "requester-nf-type", r.requesterNfType, "form", "")
	if r.preferredCollocatedNfTypes != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "preferred-collocated-nf-types", r.preferredCollocatedNfTypes, "form", "csv")
	}
	if r.requesterNfInstanceId != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "requester-nf-instance-id", r.requesterNfInstanceId, "form", "")
	}
	if r.serviceNames != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "service-names", r.serviceNames, "form", "csv")
	}
	if r.requesterNfInstanceFqdn != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "requester-nf-instance-fqdn", r.requesterNfInstanceFqdn, "form", "")
	}
	...
	if r.targetNfInstanceId != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "target-nf-instance-id", r.targetNfInstanceId, "form", "")
	}
	if r.targetNfInstanceIdList != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "target-nf-instance-id-list", r.targetNfInstanceIdList, "form", "csv")
	}
	if r.targetNfFqdn != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "target-nf-fqdn", r.targetNfFqdn, "form", "")
	}
	if r.hnrfUri != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "hnrf-uri", r.hnrfUri, "form", "")
	}
	if r.snssais != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "snssais", r.snssais, "", "csv")
	}
	if r.additionalSnssais != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "additional-snssais", r.additionalSnssais, "", "csv")
	}
	...
	if r.dnn != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "dnn", r.dnn, "form", "")
	}
	if r.ipv4Index != nil {
	...
	if r.nsiList != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "nsi-list", r.nsiList, "form", "csv")
	}
	if r.smfServingArea != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "smf-serving-area", r.smfServingArea, "form", "")
	}
	if r.mbsmfServingArea != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "mbsmf-serving-area", r.mbsmfServingArea, "form", "")
	}
	if r.tai != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "tai", r.tai, "", "")
	}
	if r.amfRegionId != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "amf-region-id", r.amfRegionId, "form", "")
	}
	if r.amfSetId != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "amf-set-id", r.amfSetId, "form", "")
	}
	if r.guami != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "guami", r.guami, "", "")
	}
	if r.supi != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "supi", r.supi, "form", "")
	}
	if r.ueIpv4Address != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "ue-ipv4-address", r.ueIpv4Address, "form", "")
	}
	if r.ipDomain != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "ip-domain", r.ipDomain, "form", "")
	}
	if r.ueIpv6Prefix != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "ue-ipv6-prefix", r.ueIpv6Prefix, "form", "")
	}
	if r.pgwInd != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "pgw-ind", r.pgwInd, "form", "")
	}
	if r.preferredPgwInd != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "preferred-pgw-ind", r.preferredPgwInd, "form", "")
	}
	if r.pgw != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "pgw", r.pgw, "form", "")
	}
	if r.pgwIp != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "pgw-ip", r.pgwIp, "", "")
	}
	if r.gpsi != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "gpsi", r.gpsi, "form", "")
	}
	if r.externalGroupIdentity != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "external-group-identity", r.externalGroupIdentity, "form", "")
	}
	if r.internalGroupIdentity != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "internal-group-identity", r.internalGroupIdentity, "form", "")
	}
	if r.pfdData != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "pfd-data", r.pfdData, "", "")
	}
	if r.dataSet != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "data-set", r.dataSet, "form", "")
	}
	if r.routingIndicator != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "routing-indicator", r.routingIndicator, "form", "")
	}
	if r.groupIdList != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "group-id-list", r.groupIdList, "form", "csv")
	}
	if r.dnaiList != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "dnai-list", r.dnaiList, "form", "csv")
	}
	if r.pduSessionTypes != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "pdu-session-types", r.pduSessionTypes, "form", "csv")
	}
	if r.eventIdList != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "event-id-list", r.eventIdList, "form", "csv")
	}
	if r.nwdafEventList != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "nwdaf-event-list", r.nwdafEventList, "form", "csv")
	}
	if r.upfEventList != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "upf-event-list", r.upfEventList, "form", "csv")
	}
	if r.supportedFeatures != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "supported-features", r.supportedFeatures, "form", "")
	}
	if r.upfIwkEpsInd != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "upf-iwk-eps-ind", r.upfIwkEpsInd, "form", "")
	}
	...
	if r.preferredLocality != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "preferred-locality", r.preferredLocality, "form", "")
	}
	...
	if r.accessType != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "access-type", r.accessType, "form", "")
	}
	if r.limit != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "limit", r.limit, "form", "")
	}
	if r.requiredFeatures != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "required-features", r.requiredFeatures, "form", "csv")
	}
	if r.complexQuery != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "complex-query", r.complexQuery, "", "")
	}
	if r.maxPayloadSize != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "max-payload-size", r.maxPayloadSize, "form", "")
	} else {
		var defaultValue int32 = 124
		r.maxPayloadSize = &defaultValue
	}
	if r.maxPayloadSizeExt != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "max-payload-size-ext", r.maxPayloadSizeExt, "form", "")
	} else {
		var defaultValue int32 = 124
	...
	if r.upfUeIpAddrInd != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "upf-ue-ip-addr-ind", r.upfUeIpAddrInd, "form", "")
	}
	if r.clientType != nil {
	...
	if r.preferredNfInstances != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "preferred-nf-instances", r.preferredNfInstances, "form", "csv")
	}
	if r.targetSnpn != nil {
	...
	if r.upfSelectEpdgInfo != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "upf-select-epdg-info", r.upfSelectEpdgInfo, "", "")
	}
	if r.targetNfSetId != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "target-nf-set-id", r.targetNfSetId, "form", "")
	}
	if r.targetNfServiceSetId != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "target-nf-service-set-id", r.targetNfServiceSetId, "form", "")
	}
	if r.nefId != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "nef-id", r.nefId, "form", "")
	}
	if r.notificationType != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "notification-type", r.notificationType, "form", "")
	}
	if r.n1MsgClass != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "n1-msg-class", r.n1MsgClass, "form", "")
	}
	if r.n2InfoClass != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "n2-info-class", r.n2InfoClass, "form", "")
	}
	if r.servingScope != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "serving-scope", r.servingScope, "form", "csv")
	}
	if r.imsi != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "imsi", r.imsi, "form", "")
	}
	if r.imsPrivateIdentity != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "ims-private-identity", r.imsPrivateIdentity, "form", "")
	}
	if r.imsPublicIdentity != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "ims-public-identity", r.imsPublicIdentity, "form", "")
	}
	if r.msisdn != nil {
	...
	if r.v2xSupportInd != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "v2x-support-ind", r.v2xSupportInd, "form", "")
	}
	if r.redundantGtpu != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "redundant-gtpu", r.redundantGtpu, "form", "")
	}
	if r.redundantTransport != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "redundant-transport", r.redundantTransport, "form", "")
	}
	if r.ipups != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "ipups", r.ipups, "form", "")
	}
	if r.sxaInd != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "sxa-ind", r.sxaInd, "form", "")
	}
	if r.scpDomainList != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "scp-domain-list", r.scpDomainList, "form", "csv")
	}
	if r.addressDomain != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "address-domain", r.addressDomain, "form", "")
	}
	if r.ipv4Addr != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "ipv4-addr", r.ipv4Addr, "form", "")
	}
	if r.ipv6Prefix != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "ipv6-prefix", r.ipv6Prefix, "form", "")
	}
	if r.servedNfSetId != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "served-nf-set-id", r.servedNfSetId, "form", "")
	}
	...
	if r.dataForwarding != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "data-forwarding", r.dataForwarding, "form", "")
	}
	if r.preferredFullPlmn != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "preferred-full-plmn", r.preferredFullPlmn, "form", "")
	}
	if r.requesterFeatures != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "requester-features", r.requesterFeatures, "form", "")
	}
	if r.realmId != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "realm-id", r.realmId, "form", "")
	}
	if r.storageId != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "storage-id", r.storageId, "form", "")
	}
	if r.vsmfSupportInd != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "vsmf-support-ind", r.vsmfSupportInd, "form", "")
	}
	if r.ismfSupportInd != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "ismf-support-ind", r.ismfSupportInd, "form", "")
	}
	if r.nrfDiscUri != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "nrf-disc-uri", r.nrfDiscUri, "form", "")
	}
	...
	if r.requiredPfcpFeatures != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "required-pfcp-features", r.requiredPfcpFeatures, "form", "")
	}
	if r.homePubKeyId != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "home-pub-key-id", r.homePubKeyId, "form", "")
	}
	if r.proseSupportInd != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "prose-support-ind", r.proseSupportInd, "form", "")
	}
	if r.analyticsAggregationInd != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "analytics-aggregation-ind", r.analyticsAggregationInd, "form", "")
	}
	if r.servingNfSetId != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "serving-nf-set-id", r.servingNfSetId, "form", "")
	}
	if r.servingNfType != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "serving-nf-type", r.servingNfType, "form", "")
	}
	...
	if r.analyticsMetadataProvInd != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "analytics-metadata-prov-ind", r.analyticsMetadataProvInd, "form", "")
	}
	if r.nsacfCapability != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "nsacf-capability", r.nsacfCapability, "form", "")
	}
	...
	if r.areaSessionId != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "area-session-id", r.areaSessionId, "form", "")
	}
	if r.gmlcNumber != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "gmlc-number", r.gmlcNumber, "form", "")
	}
	if r.upfN6Ip != nil {
	...
	if r.nfTaiListInd != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "nf-tai-list-ind", r.nfTaiListInd, "form", "")
	}
	if r.preferencesPrecedence != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "preferences-precedence", r.preferencesPrecedence, "form", "csv")
	}
	if r.supportOnboardingCapability != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "support-onboarding-capability", r.supportOnboardingCapability, "form", "")
	} else {
		var defaultValue bool = false
		r.supportOnboardingCapability = &defaultValue
	}
	if r.uasNfFunctionalityInd != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "uas-nf-functionality-ind", r.uasNfFunctionalityInd, "form", "")
	}
	if r.multiMemAfSessQosInd != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "multi-mem-af-sess-qos-ind", r.multiMemAfSessQosInd, "form", "")
	}
	if r.memberUeSelAssistInd != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "member-ue-sel-assist-ind", r.memberUeSelAssistInd, "form", "")
	}
	...
	if r.sharedDataId != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "shared-data-id", r.sharedDataId, "form", "")
	}
	if r.targetHni != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "target-hni", r.targetHni, "form", "")
	}
	if r.targetNwResolution != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "target-nw-resolution", r.targetNwResolution, "form", "")
	}
	if r.excludeNfinstList != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "exclude-nfinst-list", r.excludeNfinstList, "form", "csv")
	}
	...
	if r.excludeNfservicesetList != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "exclude-nfserviceset-list", r.excludeNfservicesetList, "form", "csv")
	}
	if r.excludeNfsetList != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "exclude-nfset-list", r.excludeNfsetList, "form", "csv")
	}
	...
	if r.highLatencyCom != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "high-latency-com", r.highLatencyCom, "form", "")
	}
	if r.nsacSai != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "nsac-sai", r.nsacSai, "form", "")
	}
	if r.completeProfile != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "complete-profile", r.completeProfile, "form", "")
	}
	if r.n32Purposes != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "n32-purposes", r.n32Purposes, "form", "csv")
	}
	...
	if r.pruTai != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "pru-tai", r.pruTai, "", "")
	}
	if r.pruSupportInd != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "pru-support-ind", r.pruSupportInd, "form", "")
	}
	if r.afData != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "af-data", r.afData, "", "")
	}
	if r.mlAccuracyCheckingInd != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "ml-accuracy-checking-ind", r.mlAccuracyCheckingInd, "form", "")
	}
	if r.analyticsAccuracyCheckingInd != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "analytics-accuracy-checking-ind", r.analyticsAccuracyCheckingInd, "form", "")
	}
	if r.a2xSupportInd != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "a2x-support-ind", r.a2xSupportInd, "form", "")
	}
	if r.a2xCapability != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "a2x-capability", r.a2xCapability, "", "")
	}
	if r.mlModelStorageInd != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "ml-model-storage-ind", r.mlModelStorageInd, "form", "")
	}
	if r.dataStorageInd != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "data-storage-ind", r.dataStorageInd, "form", "")
	}
	if r.dataSubscriptionRelocationSupportInd != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "data-subscription-relocation-support-ind", r.dataSubscriptionRelocationSupportInd, "form", "")
	}
	if r.imsDomainName != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "ims-domain-name", r.imsDomainName, "form", "")
	}
	if r.mediaCapabilityList != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "media-capability-list", r.mediaCapabilityList, "form", "csv")
	}
	if r.roamingExchangeInd != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "roaming-exchange-ind", r.roamingExchangeInd, "form", "")
	}
	if r.rangingSlPosSupportInd != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "ranging-sl-pos-support-ind", r.rangingSlPosSupportInd, "form", "")
	}
	if r.preferredUpPositioningInd != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "preferred-up-positioning-ind", r.preferredUpPositioningInd, "form", "")
	}
	if r.completeSearchResult != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "complete-search-result", r.completeSearchResult, "form", "")
	}
	if r.urspDeliveryEpsSupportInd != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "ursp-delivery-eps-support-ind", r.urspDeliveryEpsSupportInd, "form", "")
	}
