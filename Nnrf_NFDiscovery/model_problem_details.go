...
type ProblemDetails struct {
	...
	NoProfileMatchInfo   *NoProfileMatchInfo1 `json:"noProfileMatchInfo,omitempty"`
...
func (o *ProblemDetails) GetNoProfileMatchInfo() NoProfileMatchInfo1 {
	if o == nil || IsNil(o.NoProfileMatchInfo) {
		var ret NoProfileMatchInfo1
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ProblemDetails) GetNoProfileMatchInfoOk() (*NoProfileMatchInfo1, bool) {
	if o == nil || IsNil(o.NoProfileMatchInfo) {
		return nil, false
	}
...
// SetNoProfileMatchInfo gets a reference to the given NoProfileMatchInfo1 and assigns it to the NoProfileMatchInfo field.
func (o *ProblemDetails) SetNoProfileMatchInfo(v NoProfileMatchInfo1) {
