...
func (v *DnnSelectionMode) UnmarshalJSON(src []byte) error {
	...
	for _, existing := range AllowedDnnSelectionModeEnumValues {
	...
	return fmt.Errorf("%+v is not a valid DnnSelectionMode", value)
}
...
func NewDnnSelectionModeFromValue(v string) (*DnnSelectionMode, error) {
	...
	if ev.IsValid() {
		...
		return nil, fmt.Errorf("invalid value '%v' for DnnSelectionMode: valid values are %v", v, AllowedDnnSelectionModeEnumValues)
	}
}
