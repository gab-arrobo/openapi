...
type QosData struct {
	...
	MaxbrUl NullableString `json:"maxbrUl,omitempty" validate:"regexp=^\\\\d+(\\\\.\\\\d+)? (bps|Kbps|Mbps|Gbps|Tbps)$"`
	// This data type is defined in the same way as the 'BitRate' data type, but with the OpenAPI 'nullable: true' property.
	MaxbrDl NullableString `json:"maxbrDl,omitempty" validate:"regexp=^\\\\d+(\\\\.\\\\d+)? (bps|Kbps|Mbps|Gbps|Tbps)$"`
	// This data type is defined in the same way as the 'BitRate' data type, but with the OpenAPI 'nullable: true' property.
	GbrUl NullableString `json:"gbrUl,omitempty" validate:"regexp=^\\\\d+(\\\\.\\\\d+)? (bps|Kbps|Mbps|Gbps|Tbps)$"`
	// This data type is defined in the same way as the 'BitRate' data type, but with the OpenAPI 'nullable: true' property.
	GbrDl NullableString `json:"gbrDl,omitempty" validate:"regexp=^\\\\d+(\\\\.\\\\d+)? (bps|Kbps|Mbps|Gbps|Tbps)$"`
	...
	PacketErrorRate      *string               `json:"packetErrorRate,omitempty" validate:"regexp=^([0-9]E-[0-9])$"`
...
func (o *QosData) GetPduSetQosDl() PduSetQosPara {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *QosData) GetPduSetQosDlOk() (*PduSetQosPara, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *QosData) SetPduSetQosDl(v PduSetQosPara) {
	o.PduSetQosDl.Set(&v)
}
...
func (o *QosData) GetPduSetQosUl() PduSetQosPara {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *QosData) GetPduSetQosUlOk() (*PduSetQosPara, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *QosData) SetPduSetQosUl(v PduSetQosPara) {
	o.PduSetQosUl.Set(&v)
}
