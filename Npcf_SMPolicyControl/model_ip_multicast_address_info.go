...
type IpMulticastAddressInfo struct {
	...
	SrcIpv4Addr *string `json:"srcIpv4Addr,omitempty" validate:"regexp=^(([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])\\\\.){3}([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])$"`
	// String identifying a IPv4 address formatted in the 'dotted decimal' notation as defined in RFC 1166.
	Ipv4MulAddr          *string   `json:"ipv4MulAddr,omitempty" validate:"regexp=^(([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])\\\\.){3}([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])$"`
	SrcIpv6Addr          *Ipv6Addr `json:"srcIpv6Addr,omitempty"`
	Ipv6MulAddr          *Ipv6Addr `json:"ipv6MulAddr,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _IpMulticastAddressInfo IpMulticastAddressInfo
