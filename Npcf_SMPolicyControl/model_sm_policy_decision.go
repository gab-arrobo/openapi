...
type SmPolicyDecision struct {
	...
	SliceUsgCtrlInfo NullableSliceUsgCtrlInfo `json:"sliceUsgCtrlInfo,omitempty"`
	// List of VPLMN Specific offloading information.
	VplmnOffloadInfos    []VplmnOffloadingInfo `json:"vplmnOffloadInfos,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _SmPolicyDecision SmPolicyDecision
...
func (o *SmPolicyDecision) GetSliceUsgCtrlInfo() SliceUsgCtrlInfo {
	if o == nil || IsNil(o.SliceUsgCtrlInfo.Get()) {
		var ret SliceUsgCtrlInfo
		return ret
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *SmPolicyDecision) GetSliceUsgCtrlInfoOk() (*SliceUsgCtrlInfo, bool) {
	if o == nil {
		return nil, false
	}
...
// SetSliceUsgCtrlInfo gets a reference to the given NullableSliceUsgCtrlInfo and assigns it to the SliceUsgCtrlInfo field.
func (o *SmPolicyDecision) SetSliceUsgCtrlInfo(v SliceUsgCtrlInfo) {
...
func (o *SmPolicyDecision) GetVplmnOffloadInfos() []VplmnOffloadingInfo {
	if o == nil || IsNil(o.VplmnOffloadInfos) {
