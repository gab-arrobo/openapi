...
// SetSgsnIpv6Addr gets a reference to the given Ipv6Addr and assigns it to the SgsnIpv6Addr field.
func (o *SgsnAddress) SetSgsnIpv6Addr(v Ipv6Addr) {
	o.SgsnIpv6Addr = &v
}

func (o SgsnAddress) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.SgsnIpv4Addr) {
		toSerialize["sgsnIpv4Addr"] = o.SgsnIpv4Addr
	}
	if !IsNil(o.SgsnIpv6Addr) {
