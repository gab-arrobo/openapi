...
type SmPolicyUpdateContextData struct {
	...
	RelIpv4Address *string `json:"relIpv4Address,omitempty" validate:"regexp=^(([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])\\\\.){3}([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])$"`
	// String identifying a IPv4 address formatted in the 'dotted decimal' notation as defined in RFC 1166.
	...
	MultiIpv6Prefixes []Ipv6Prefix `json:"multiIpv6Prefixes,omitempty"`
	// The multiple released IPv6 prefixes of the served UE.
	MultiRelIpv6Prefixes []Ipv6Prefix `json:"multiRelIpv6Prefixes,omitempty"`
	// String identifying a MAC address formatted in the hexadecimal notation according to clause 1.1 and clause 2.1 of RFC 7042.
	RelUeMac *string `json:"relUeMac,omitempty" validate:"regexp=^([0-9a-fA-F]{2})((-[0-9a-fA-F]{2}){5})$"`
	// String identifying a MAC address formatted in the hexadecimal notation according to clause 1.1 and clause 2.1 of RFC 7042.
	...
	QosMonCongReps    []QosMonitoringReport `json:"qosMonCongReps,omitempty"`
	...
	UePolCont *string `json:"uePolCont,omitempty"`
	// string with format 'bytes' as defined in OpenAPI
	UrspEnfInfo *string  `json:"urspEnfInfo,omitempty"`
	...
	L4sReports    []L4sSupportInfo `json:"l4sReports,omitempty"`
	AltSliceInfo  *Snssai          `json:"altSliceInfo,omitempty"`
	...
	HrsboInd             *bool `json:"hrsboInd,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _SmPolicyUpdateContextData SmPolicyUpdateContextData
...
func (o *SmPolicyUpdateContextData) GetMultiIpv6Prefixes() []Ipv6Prefix {
	if o == nil || IsNil(o.MultiIpv6Prefixes) {
		var ret []Ipv6Prefix
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *SmPolicyUpdateContextData) GetMultiIpv6PrefixesOk() ([]Ipv6Prefix, bool) {
	if o == nil || IsNil(o.MultiIpv6Prefixes) {
		return nil, false
	}
...
// SetMultiIpv6Prefixes gets a reference to the given []Ipv6Prefix and assigns it to the MultiIpv6Prefixes field.
func (o *SmPolicyUpdateContextData) SetMultiIpv6Prefixes(v []Ipv6Prefix) {
	o.MultiIpv6Prefixes = v
}

// GetMultiRelIpv6Prefixes returns the MultiRelIpv6Prefixes field value if set, zero value otherwise.
func (o *SmPolicyUpdateContextData) GetMultiRelIpv6Prefixes() []Ipv6Prefix {
	if o == nil || IsNil(o.MultiRelIpv6Prefixes) {
		var ret []Ipv6Prefix
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *SmPolicyUpdateContextData) GetMultiRelIpv6PrefixesOk() ([]Ipv6Prefix, bool) {
	if o == nil || IsNil(o.MultiRelIpv6Prefixes) {
		return nil, false
	}
...
// SetMultiRelIpv6Prefixes gets a reference to the given []Ipv6Prefix and assigns it to the MultiRelIpv6Prefixes field.
func (o *SmPolicyUpdateContextData) SetMultiRelIpv6Prefixes(v []Ipv6Prefix) {
...
func (o *SmPolicyUpdateContextData) GetQosMonCongReps() []QosMonitoringReport {
	if o == nil || IsNil(o.QosMonCongReps) {
		var ret []QosMonitoringReport
		return ret
	}
...
func (o SmPolicyUpdateContextData) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.MultiIpv6Prefixes) {
		toSerialize["multiIpv6Prefixes"] = o.MultiIpv6Prefixes
	}
	if !IsNil(o.MultiRelIpv6Prefixes) {
	...
	if !IsNil(o.UePolCont) {
		toSerialize["uePolCont"] = o.UePolCont
	}
	if !IsNil(o.UrspEnfInfo) {
