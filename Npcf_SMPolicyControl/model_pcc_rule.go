...
type PccRule struct {
	...
	NscSuppFeats         *map[string]string `json:"nscSuppFeats,omitempty"`
	CallInfo             NullableCallInfo   `json:"callInfo,omitempty"`
	TraffParaData        *TrafficParaData   `json:"traffParaData,omitempty"`
...
func (o *PccRule) GetTraffParaData() TrafficParaData {
	if o == nil || IsNil(o.TraffParaData) {
