...
type FlowInformation struct {
	...
	FlowDirection        NullableFlowDirection `json:"flowDirection,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _FlowInformation FlowInformation
...
func (o *FlowInformation) GetFlowDirection() FlowDirection {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *FlowInformation) GetFlowDirectionOk() (*FlowDirection, bool) {
	if o == nil {
		return nil, false
	}
...
// SetFlowDirection gets a reference to the given NullableFlowDirection and assigns it to the FlowDirection field.
func (o *FlowInformation) SetFlowDirection(v FlowDirection) {
