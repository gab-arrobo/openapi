...
type QosMonitoringReport struct {
	...
	UlCongInfo *int32 `json:"ulCongInfo,omitempty"`
	// Unsigned Integer, i.e. only value 0 and integers above 0 are permissible.
	DlCongInfo           *int32 `json:"dlCongInfo,omitempty"`
...
func (o QosMonitoringReport) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.UlCongInfo) {
		toSerialize["ulCongInfo"] = o.UlCongInfo
	}
	if !IsNil(o.DlCongInfo) {
