...
func (dst *SmPoliciesPost200Response) UnmarshalJSON(data []byte) error {
	...
	err = json.Unmarshal(data, &dst.UeCampingRep)
	if err == nil {
	...
	err = json.Unmarshal(data, &dst.ArrayOfPartialSuccessReport)
	if err == nil {
	...
	err = json.Unmarshal(data, &dst.ArrayOfPolicyDecisionFailureCode)
	if err == nil {
