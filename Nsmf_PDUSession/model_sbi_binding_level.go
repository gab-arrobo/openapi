...
func (v *SbiBindingLevel) UnmarshalJSON(src []byte) error {
	...
	for _, existing := range AllowedSbiBindingLevelEnumValues {
	...
	return fmt.Errorf("%+v is not a valid SbiBindingLevel", value)
}
...
func NewSbiBindingLevelFromValue(v string) (*SbiBindingLevel, error) {
	...
	if ev.IsValid() {
		...
		return nil, fmt.Errorf("invalid value '%v' for SbiBindingLevel: valid values are %v", v, AllowedSbiBindingLevelEnumValues)
	}
}
