...
type _PduSessionCreateData PduSessionCreateData
...
func (o *PduSessionCreateData) GetN9ForwardingTunnelInfo() TunnelInfo {
	if o == nil || IsNil(o.N9ForwardingTunnelInfo) {
		var ret TunnelInfo
		return ret
	}
...
func (o *PduSessionCreateData) GetDlServingPlmnRateCtl() int32 {
	if o == nil || IsNil(o.DlServingPlmnRateCtl) {
		var ret int32
		return ret
	}
...
func (o PduSessionCreateData) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.N9ForwardingTunnelInfo) {
	...
	if !IsNil(o.DlServingPlmnRateCtl) {
