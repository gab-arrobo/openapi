...
type VsmfUpdateData struct {
	...
	HrsboInfo             *HrsboInfoFromHplmn `json:"hrsboInfo,omitempty"`
	AltHplmnSnssai        *Snssai             `json:"altHplmnSnssai,omitempty"`
	PduSessionRetainInd   *bool               `json:"pduSessionRetainInd,omitempty"`
	PendingUpdateInfoList []PendingUpdateInfo `json:"pendingUpdateInfoList,omitempty"`
	AdditionalProperties  map[string]interface{}
}

type _VsmfUpdateData VsmfUpdateData
...
func (o *VsmfUpdateData) GetPduSessionRetainInd() bool {
	if o == nil || IsNil(o.PduSessionRetainInd) {
		var ret bool
		return ret
	}
...
func (o VsmfUpdateData) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.PduSessionRetainInd) {
