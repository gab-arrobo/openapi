...
type VsmfUpdatedData struct {
	...
	QosFlowsVsmfRejectedAddModList []int32          `json:"qosFlowsVsmfRejectedAddModList,omitempty"`
...
type _VsmfUpdatedData VsmfUpdatedData
...
func (o *VsmfUpdatedData) GetQosFlowsVsmfRejectedAddModList() []int32 {
	if o == nil || IsNil(o.QosFlowsVsmfRejectedAddModList) {
		var ret []int32
		return ret
	}
...
func (o *VsmfUpdatedData) GetModifiedEbiListNotDelivered() bool {
	if o == nil || IsNil(o.ModifiedEbiListNotDelivered) {
		var ret bool
		return ret
	}
...
func (o VsmfUpdatedData) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.QosFlowsVsmfRejectedAddModList) {
	...
	if !IsNil(o.ModifiedEbiListNotDelivered) {
