...
func (v *SteeringFunctionality) UnmarshalJSON(src []byte) error {
	...
	for _, existing := range AllowedSteeringFunctionalityEnumValues {
	...
	return fmt.Errorf("%+v is not a valid SteeringFunctionality", value)
}
...
func NewSteeringFunctionalityFromValue(v string) (*SteeringFunctionality, error) {
	...
	if ev.IsValid() {
		...
		return nil, fmt.Errorf("invalid value '%v' for SteeringFunctionality: valid values are %v", v, AllowedSteeringFunctionalityEnumValues)
	}
}
