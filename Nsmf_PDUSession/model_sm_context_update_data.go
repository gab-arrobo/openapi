...
type SmContextUpdateData struct {
	...
	AnTypeOfN1N2Info   *AccessType     `json:"anTypeOfN1N2Info,omitempty"`
	...
	N3gPathSwitchExecutionInd *bool                      `json:"n3gPathSwitchExecutionInd,omitempty"`
...
type _SmContextUpdateData SmContextUpdateData
...
func (o *SmContextUpdateData) GetAnTypeOfN1N2Info() AccessType {
	if o == nil || IsNil(o.AnTypeOfN1N2Info) {
		var ret AccessType
		return ret
	}
...
func (o *SmContextUpdateData) GetN3gPathSwitchExecutionInd() bool {
	if o == nil || IsNil(o.N3gPathSwitchExecutionInd) {
		var ret bool
		return ret
	}
...
func (o SmContextUpdateData) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.N3gPathSwitchExecutionInd) {
