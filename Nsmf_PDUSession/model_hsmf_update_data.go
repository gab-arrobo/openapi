...
type HsmfUpdateData struct {
	...
	QosFlowsVsmfRejectedList []int32                `json:"qosFlowsVsmfRejectedList,omitempty"`
	...
	EcsAddrConfigInfos                   []EcsAddrConfigInfo              `json:"ecsAddrConfigInfos,omitempty"`
	HrsboInfo                            *HrsboInfoFromVplmn              `json:"hrsboInfo,omitempty"`
	AltSnssai                            *Snssai                          `json:"altSnssai,omitempty"`
	NsReplTerminInd                      *bool                            `json:"nsReplTerminInd,omitempty"`
	DisasterRoamingInd                   *bool                            `json:"disasterRoamingInd,omitempty"`
	PduSetSupportInd                     *bool                            `json:"pduSetSupportInd,omitempty"`
	EcnMarkingCongestionInfoStatus       []EcnMarkingCongestionInfoStatus `json:"ecnMarkingCongestionInfoStatus,omitempty"`
	AdditionalProperties                 map[string]interface{}
}

type _HsmfUpdateData HsmfUpdateData
...
func (o *HsmfUpdateData) GetQosFlowsVsmfRejectedList() []int32 {
	if o == nil || IsNil(o.QosFlowsVsmfRejectedList) {
		var ret []int32
		return ret
	}
...
func (o *HsmfUpdateData) GetEcsAddrConfigInfos() []EcsAddrConfigInfo {
	if o == nil || IsNil(o.EcsAddrConfigInfos) {
...
func (o *HsmfUpdateData) GetNsReplTerminInd() bool {
	if o == nil || IsNil(o.NsReplTerminInd) {
		var ret bool
		return ret
	}
...
func (o *HsmfUpdateData) GetPduSetSupportInd() bool {
	if o == nil || IsNil(o.PduSetSupportInd) {
		var ret bool
		return ret
	}
...
func (o *HsmfUpdateData) GetEcnMarkingCongestionInfoStatus() []EcnMarkingCongestionInfoStatus {
	if o == nil || IsNil(o.EcnMarkingCongestionInfoStatus) {
...
func (o HsmfUpdateData) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.QosFlowsVsmfRejectedList) {
	...
	if !IsNil(o.PduSetSupportInd) {
		toSerialize["pduSetSupportInd"] = o.PduSetSupportInd
	}
	if !IsNil(o.EcnMarkingCongestionInfoStatus) {
