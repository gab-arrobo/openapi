...
type QosFlowAddModifyRequestItem struct {
	...
	// string with format 'bytes' as defined in OpenAPI
	ProtocolDescription *string `json:"protocolDescription,omitempty"`
	// string with format 'bytes' as defined in OpenAPI
	...
	EcnMarkingCongestInfoReq NullableEcnMarkingCongestionInfoReq `json:"ecnMarkingCongestInfoReq,omitempty"`
	TscaiUl                  *TscAssistanceInformation           `json:"tscaiUl,omitempty"`
	TscaiDl                  *TscAssistanceInformation           `json:"tscaiDl,omitempty"`
	AdditionalProperties     map[string]interface{}
}

type _QosFlowAddModifyRequestItem QosFlowAddModifyRequestItem
...
func (o *QosFlowAddModifyRequestItem) GetProtocolDescription() string {
	if o == nil || IsNil(o.ProtocolDescription) {
		var ret string
		return ret
	}
...
func (o *QosFlowAddModifyRequestItem) GetEcnMarkingCongestInfoReq() EcnMarkingCongestionInfoReq {
	if o == nil || IsNil(o.EcnMarkingCongestInfoReq.Get()) {
...
func (o QosFlowAddModifyRequestItem) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.ProtocolDescription) {
