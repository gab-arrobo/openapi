...
type TrafficControlData struct {
	...
	TransMode      *TransportMode          `json:"transMode,omitempty"`
	...
	DatEndMarkInd        *bool `json:"datEndMarkInd,omitempty"`
...
func (o *TrafficControlData) GetDatEndMarkInd() bool {
	if o == nil || IsNil(o.DatEndMarkInd) {
		var ret bool
		return ret
	}
...
func (o TrafficControlData) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.CandDnaiInd) {
		toSerialize["candDnaiInd"] = o.CandDnaiInd
	}
	if !IsNil(o.DatEndMarkInd) {
