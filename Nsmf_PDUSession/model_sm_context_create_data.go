...
type SmContextCreateData struct {
	...
	PerLadnDnnSnssaiInd *bool            `json:"perLadnDnnSnssaiInd,omitempty"`
	...
	EpsBearerCtxStatus      *string          `json:"epsBearerCtxStatus,omitempty" validate:"regexp=^[A-Fa-f0-9]{4}$"`
	...
	N3gPathSwitchSupportInd *bool            `json:"n3gPathSwitchSupportInd,omitempty"`
	...
	GeoSatelliteId       *string                      `json:"geoSatelliteId,omitempty"`
	HrsboAllowedInd      *bool                        `json:"hrsboAllowedInd,omitempty"`
	EstabRejectionInd    *bool                        `json:"estabRejectionInd,omitempty"`
	EstabRejectionCause  *EstablishmentRejectionCause `json:"estabRejectionCause,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _SmContextCreateData SmContextCreateData
...
func (o *SmContextCreateData) GetPerLadnDnnSnssaiInd() bool {
	if o == nil || IsNil(o.PerLadnDnnSnssaiInd) {
		var ret bool
		return ret
	}
...
func (o *SmContextCreateData) GetN3gPathSwitchSupportInd() bool {
	if o == nil || IsNil(o.N3gPathSwitchSupportInd) {
		var ret bool
		return ret
	}
...
func (o *SmContextCreateData) GetGeoSatelliteId() string {
	if o == nil || IsNil(o.GeoSatelliteId) {
		var ret string
		return ret
	}
...
func (o *SmContextCreateData) GetHrsboAllowedInd() bool {
	if o == nil || IsNil(o.HrsboAllowedInd) {
		var ret bool
		return ret
	}
...
func (o *SmContextCreateData) GetEstabRejectionInd() bool {
	if o == nil || IsNil(o.EstabRejectionInd) {
		var ret bool
		return ret
	}
...
func (o *SmContextCreateData) GetEstabRejectionCause() EstablishmentRejectionCause {
	if o == nil || IsNil(o.EstabRejectionCause) {
...
func (o SmContextCreateData) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.PerLadnDnnSnssaiInd) {
	...
	if !IsNil(o.N3gPathSwitchSupportInd) {
