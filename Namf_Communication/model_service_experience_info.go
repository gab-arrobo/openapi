...
type ServiceExperienceInfo struct {
	...
	PduSesInfo           *PduSessionInfo1    `json:"pduSesInfo,omitempty"`
...
func (o *ServiceExperienceInfo) GetPduSesInfo() PduSessionInfo1 {
	if o == nil || IsNil(o.PduSesInfo) {
...
// and a boolean to check if the value has been set.
func (o *ServiceExperienceInfo) GetPduSesInfoOk() (*PduSessionInfo1, bool) {
	if o == nil || IsNil(o.PduSesInfo) {
		return nil, false
	}
...
// SetPduSesInfo gets a reference to the given PduSessionInfo1 and assigns it to the PduSesInfo field.
func (o *ServiceExperienceInfo) SetPduSesInfo(v PduSessionInfo1) {
	o.PduSesInfo = &v
}
