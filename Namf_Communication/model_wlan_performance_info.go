...
type WlanPerformanceInfo struct {
	...
	WlanPerUeIdInfos     []WlanPerUeIdPerformanceInfo `json:"wlanPerUeIdInfos,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _WlanPerformanceInfo WlanPerformanceInfo
...
func (o *WlanPerformanceInfo) GetWlanPerUeIdInfos() []WlanPerUeIdPerformanceInfo {
	if o == nil || IsNil(o.WlanPerUeIdInfos) {
