...
type ProseContext struct {
	...
	L3Remote        *UeAuth `json:"l3Remote,omitempty"`
	L2UeRelay       *UeAuth `json:"l2UeRelay,omitempty"`
	L3UeRelay       *UeAuth `json:"l3UeRelay,omitempty"`
	L2End           *UeAuth `json:"l2End,omitempty"`
	L3End           *UeAuth `json:"l3End,omitempty"`
	MultiPathComm   *UeAuth `json:"multiPathComm,omitempty"`
...
type _ProseContext ProseContext
...
func (o *ProseContext) GetMultiPathComm() UeAuth {
	if o == nil || IsNil(o.MultiPathComm) {
		var ret UeAuth
		return ret
	}
...
func (o ProseContext) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.L2UeRelay) {
		toSerialize["l2UeRelay"] = o.L2UeRelay
	}
	if !IsNil(o.L3UeRelay) {
