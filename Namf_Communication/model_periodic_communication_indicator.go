...
func (v *PeriodicCommunicationIndicator) UnmarshalJSON(src []byte) error {
	...
	for _, existing := range AllowedPeriodicCommunicationIndicatorEnumValues {
	...
	return fmt.Errorf("%+v is not a valid PeriodicCommunicationIndicator", value)
}
...
func NewPeriodicCommunicationIndicatorFromValue(v string) (*PeriodicCommunicationIndicator, error) {
	...
	if ev.IsValid() {
		...
		return nil, fmt.Errorf("invalid value '%v' for PeriodicCommunicationIndicator: valid values are %v", v, AllowedPeriodicCommunicationIndicatorEnumValues)
	}
}
