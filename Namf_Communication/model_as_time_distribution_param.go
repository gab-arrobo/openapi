...
type AsTimeDistributionParam struct {
	...
	ClkQltDetLvl         *ClockQualityDetailLevel         `json:"clkQltDetLvl,omitempty"`
	ClkQltAcptCri        *ClockQualityAcceptanceCriterion `json:"clkQltAcptCri,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _AsTimeDistributionParam AsTimeDistributionParam
...
func (o *AsTimeDistributionParam) GetClkQltAcptCri() ClockQualityAcceptanceCriterion {
	if o == nil || IsNil(o.ClkQltAcptCri) {
...
func (o AsTimeDistributionParam) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.ClkQltDetLvl) {
		toSerialize["clkQltDetLvl"] = o.ClkQltDetLvl
	}
	if !IsNil(o.ClkQltAcptCri) {
