...
var _ MappedNullable = &A2xContext{}
...
type A2xContext struct {
	...
	NrUeSidelinkAmbr *string `json:"nrUeSidelinkAmbr,omitempty" validate:"regexp=^\\\\d+(\\\\.\\\\d+)? (bps|Kbps|Mbps|Gbps|Tbps)$"`
	// String representing a bit rate; the prefixes follow the standard symbols from The International System of Units, and represent x1000 multipliers, with the exception that prefix \"K\" is used to represent the standard symbol \"k\".
	LteUeSidelinkAmbr    *string     `json:"lteUeSidelinkAmbr,omitempty" validate:"regexp=^\\\\d+(\\\\.\\\\d+)? (bps|Kbps|Mbps|Gbps|Tbps)$"`
	Pc5QoSPara           *Pc5QoSPara `json:"pc5QoSPara,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _A2xContext A2xContext
...
func (o A2xContext) ToMap() (map[string]interface{}, error) {
