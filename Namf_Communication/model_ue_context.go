...
type UeContext struct {
	...
	AdjacenPlmnMngtMdtInds     *map[string]bool        `json:"adjacenPlmnMngtMdtInds,omitempty"`
	...
	AmPolicyInfoContainer *AmPolicyInfoContainer          `json:"amPolicyInfoContainer,omitempty"`
	A2xContext            *A2xContext                     `json:"a2xContext,omitempty"`
	MbsrOperationAllowed  *MbsrOperationAllowed           `json:"mbsrOperationAllowed,omitempty"`
	LcsUpContext          *LcsUpContext                   `json:"lcsUpContext,omitempty"`
	ReconnectInd          *bool                           `json:"reconnectInd,omitempty"`
	AdditionalProperties  map[string]interface{}
}

type _UeContext UeContext
...
func (o *UeContext) GetAdjacenPlmnMngtMdtInds() map[string]bool {
	if o == nil || IsNil(o.AdjacenPlmnMngtMdtInds) {
...
func (o *UeContext) GetAmPolicyInfoContainer() AmPolicyInfoContainer {
	if o == nil || IsNil(o.AmPolicyInfoContainer) {
...
func (o UeContext) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.AdjacenPlmnMngtMdtInds) {
	...
	if !IsNil(o.LcsUpContext) {
		toSerialize["lcsUpContext"] = o.LcsUpContext
	}
	if !IsNil(o.ReconnectInd) {
