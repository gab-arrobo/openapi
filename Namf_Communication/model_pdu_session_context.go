...
type PduSessionContext struct {
	...
	AltAdditionalSnssai *Snssai `json:"altAdditionalSnssai,omitempty"`
	// String providing an URI formatted according to RFC 3986.
	...
	AnchorSmfSupportedFeatures *string `json:"anchorSmfSupportedFeatures,omitempty" validate:"regexp=^[A-Fa-f0-9]*$"`
...
type _PduSessionContext PduSessionContext
...
func (o *PduSessionContext) GetAltAdditionalSnssai() Snssai {
	if o == nil || IsNil(o.AltAdditionalSnssai) {
		var ret Snssai
		return ret
	}
...
func (o PduSessionContext) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.AltAdditionalSnssai) {
