...
func (dst *VelocityEstimate) UnmarshalJSON(data []byte) error {
	...
	err = json.Unmarshal(data, &dst.HorizontalVelocity)
	if err == nil {
	...
	err = json.Unmarshal(data, &dst.HorizontalVelocityWithUncertainty)
	if err == nil {
	...
	err = json.Unmarshal(data, &dst.HorizontalWithVerticalVelocity)
	if err == nil {
	...
	err = json.Unmarshal(data, &dst.HorizontalWithVerticalVelocityAndUncertainty)
	if err == nil {
