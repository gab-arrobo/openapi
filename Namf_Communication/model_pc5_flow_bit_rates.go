...
type Pc5FlowBitRates struct {
	...
	GuaFbr *string `json:"guaFbr,omitempty" validate:"regexp=^\\\\d+(\\\\.\\\\d+)? (bps|Kbps|Mbps|Gbps|Tbps)$"`
	// String representing a bit rate; the prefixes follow the standard symbols from The International System of Units, and represent x1000 multipliers, with the exception that prefix \"K\" is used to represent the standard symbol \"k\".
	MaxFbr               *string `json:"maxFbr,omitempty" validate:"regexp=^\\\\d+(\\\\.\\\\d+)? (bps|Kbps|Mbps|Gbps|Tbps)$"`
	AdditionalProperties map[string]interface{}
}

type _Pc5FlowBitRates Pc5FlowBitRates
