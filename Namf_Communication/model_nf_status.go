...
// checks if the NfStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NfStatus{}
...
func (o *NfStatus) GetStatusRegistered() int32 {
	if o == nil || IsNil(o.StatusRegistered) {
		var ret int32
		return ret
	}
...
func (o *NfStatus) GetStatusUnregistered() int32 {
	if o == nil || IsNil(o.StatusUnregistered) {
		var ret int32
		return ret
	}
...
func (o *NfStatus) GetStatusUndiscoverable() int32 {
	if o == nil || IsNil(o.StatusUndiscoverable) {
		var ret int32
		return ret
	}
