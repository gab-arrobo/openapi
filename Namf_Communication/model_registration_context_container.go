...
type RegistrationContextContainer struct {
	...
	InitialAmfName   string       `json:"initialAmfName" validate:"regexp=^([0-9A-Za-z]([-0-9A-Za-z]{0,61}[0-9A-Za-z])?\\\\.)+[A-Za-z]{2,63}\\\\.?$"`
	UserLocation     UserLocation `json:"userLocation"`
	RrcEstCause      *string      `json:"rrcEstCause,omitempty" validate:"regexp=^[0-9a-fA-F]+$"`
	...
	AnN2IPv4Addr         *string            `json:"anN2IPv4Addr,omitempty" validate:"regexp=^(([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])\\\\.){3}([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])$"`
	...
	MbsrNodeInd          *bool              `json:"mbsrNodeInd,omitempty"`
...
type _RegistrationContextContainer RegistrationContextContainer
