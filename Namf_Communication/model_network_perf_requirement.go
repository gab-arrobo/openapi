...
type NetworkPerfRequirement struct {
	...
	OrderCriterion       *NetworkPerfOrderCriterion `json:"orderCriterion,omitempty"`
	RscUsgReq            *ResourceUsageRequirement  `json:"rscUsgReq,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _NetworkPerfRequirement NetworkPerfRequirement
