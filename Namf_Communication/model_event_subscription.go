...
type EventSubscription struct {
	...
	Deviations []int32  `json:"deviations,omitempty"`
	...
	Location      NullableGeoLocation `json:"location,omitempty"`
	// indicating a time in seconds.
	TemporalGranSize *int32 `json:"temporalGranSize,omitempty"`
	// Unsigned Integer, i.e. only value 0 and integers above 0 are permissible.
	SpatialGranSizeTa *int32 `json:"spatialGranSizeTa,omitempty"`
	// Unsigned Integer, i.e. only value 0 and integers above 0 are permissible.
	SpatialGranSizeCell *int32 `json:"spatialGranSizeCell,omitempty"`
	// Indicates the fine granularity areas to which the subscription applies.
	FineGranAreas []GeographicalArea `json:"fineGranAreas,omitempty"`
	...
	RoamingInfo         *RoamingInfo                  `json:"roamingInfo,omitempty"`
	CongThresholds      []ThresholdLevel              `json:"congThresholds,omitempty"`
	NwPerfRequs         []NetworkPerfRequirement      `json:"nwPerfRequs,omitempty"`
	UeCommReqs          []UeCommReq                   `json:"ueCommReqs,omitempty"`
	UeMobilityReqs      []UeMobilityReq               `json:"ueMobilityReqs,omitempty"`
	UserDataConOrderCri *UserDataConOrderCrit         `json:"userDataConOrderCri,omitempty"`
	...
	PduSesInfos         []PduSessionInfo1             `json:"pduSesInfos,omitempty"`
	// Indicates the context of usage of the analytics. The value and format of this parameter are not standardized.
	UseCaseCxt      *string                  `json:"useCaseCxt,omitempty"`
	PduSesTrafReqs  []PduSesTrafficReq       `json:"pduSesTrafReqs,omitempty"`
	LocAccReqs      []LocAccuracyReq         `json:"locAccReqs,omitempty"`
	LocGranularity  *LocInfoGranularity      `json:"locGranularity,omitempty"`
	LocOrientation  *LocationOrientation     `json:"locOrientation,omitempty"`
	DataVlTrnsTmRqs []E2eDataVolTransTimeReq `json:"dataVlTrnsTmRqs,omitempty"`
	AccuReq         *AccuracyReq             `json:"accuReq,omitempty"`
	...
	PauseFlg *bool `json:"pauseFlg,omitempty"`
	...
	ResumeFlg            *bool                  `json:"resumeFlg,omitempty"`
	MovBehavReqs         []MovBehavReq          `json:"movBehavReqs,omitempty"`
	RelProxReqs          []RelProxReq           `json:"relProxReqs,omitempty"`
	Feedback             *AnalyticsFeedbackInfo `json:"feedback,omitempty"`
...
func (o *EventSubscription) GetTemporalGranSize() int32 {
	if o == nil || IsNil(o.TemporalGranSize) {
		var ret int32
		return ret
	}
...
func (o *EventSubscription) GetSpatialGranSizeTa() int32 {
	if o == nil || IsNil(o.SpatialGranSizeTa) {
		var ret int32
		return ret
	}
...
func (o *EventSubscription) GetSpatialGranSizeCell() int32 {
	if o == nil || IsNil(o.SpatialGranSizeCell) {
		var ret int32
		return ret
	}
...
func (o *EventSubscription) GetFineGranAreas() []GeographicalArea {
	if o == nil || IsNil(o.FineGranAreas) {
...
func (o *EventSubscription) GetUeMobilityReqs() []UeMobilityReq {
	if o == nil || IsNil(o.UeMobilityReqs) {
...
func (o *EventSubscription) GetUserDataConOrderCri() UserDataConOrderCrit {
	if o == nil || IsNil(o.UserDataConOrderCri) {
...
func (o *EventSubscription) GetPduSesInfos() []PduSessionInfo1 {
	if o == nil || IsNil(o.PduSesInfos) {
		var ret []PduSessionInfo1
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *EventSubscription) GetPduSesInfosOk() ([]PduSessionInfo1, bool) {
	if o == nil || IsNil(o.PduSesInfos) {
		return nil, false
	}
...
// SetPduSesInfos gets a reference to the given []PduSessionInfo1 and assigns it to the PduSesInfos field.
func (o *EventSubscription) SetPduSesInfos(v []PduSessionInfo1) {
	o.PduSesInfos = v
}
...
func (o *EventSubscription) GetLocGranularity() LocInfoGranularity {
	if o == nil || IsNil(o.LocGranularity) {
...
func (o *EventSubscription) GetLocOrientation() LocationOrientation {
	if o == nil || IsNil(o.LocOrientation) {
...
func (o *EventSubscription) GetDataVlTrnsTmRqs() []E2eDataVolTransTimeReq {
	if o == nil || IsNil(o.DataVlTrnsTmRqs) {
