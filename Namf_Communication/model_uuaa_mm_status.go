...
func (v *UuaaMmStatus) UnmarshalJSON(src []byte) error {
	...
	for _, existing := range AllowedUuaaMmStatusEnumValues {
	...
	return fmt.Errorf("%+v is not a valid UuaaMmStatus", value)
}
...
func NewUuaaMmStatusFromValue(v string) (*UuaaMmStatus, error) {
	...
	if ev.IsValid() {
		...
		return nil, fmt.Errorf("invalid value '%v' for UuaaMmStatus: valid values are %v", v, AllowedUuaaMmStatusEnumValues)
	}
}
