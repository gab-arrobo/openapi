...
type N2InfoContainer struct {
	...
	TssInfo              *TssInformation    `json:"tssInfo,omitempty"`
	RslpInfo             *RslpInformation   `json:"rslpInfo,omitempty"`
	A2xInfo              *A2xInformation    `json:"a2xInfo,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _N2InfoContainer N2InfoContainer
