...
var _ MappedNullable = &TrafficInformation{}
...
type _TrafficInformation TrafficInformation
...
func (o TrafficInformation) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.UplinkRate) {
		toSerialize["uplinkRate"] = o.UplinkRate
	}
	if !IsNil(o.DownlinkRate) {
