...
type N2InformationNotification struct {
	...
	InitialAmfName *string `json:"initialAmfName,omitempty" validate:"regexp=^([0-9A-Za-z]([-0-9A-Za-z]{0,61}[0-9A-Za-z])?\\\\.)+[A-Za-z]{2,63}\\\\.?$"`
...
type _N2InformationNotification N2InformationNotification
...
func (o *N2InformationNotification) GetRanNodeId() GlobalRanNodeId {
	if o == nil || IsNil(o.RanNodeId.Get()) {
...
func (o *N2InformationNotification) GetNotifCorrelationId() string {
	if o == nil || IsNil(o.NotifCorrelationId) {
		var ret string
		return ret
	}
