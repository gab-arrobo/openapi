...
func (o *AreaScope) GetCagInfoPerPlmn() map[string]CagInfo1 {
	if o == nil || IsNil(o.CagInfoPerPlmn) {
...
// SetCagInfoPerPlmn gets a reference to the given map[string]CagInfo1 and assigns it to the CagInfoPerPlmn field.
...
func (o *AreaScope) GetNidInfoPerPlmn() map[string]NidInfo {
	if o == nil || IsNil(o.NidInfoPerPlmn) {
...
func (o AreaScope) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.CagInfoPerPlmn) {
		toSerialize["cagInfoPerPlmn"] = o.CagInfoPerPlmn
	}
	if !IsNil(o.NidInfoPerPlmn) {
