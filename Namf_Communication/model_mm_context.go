...
type MmContext struct {
	...
	PartiallyAllowedNssai     []PartiallyAllowedSnssai  `json:"partiallyAllowedNssai,omitempty"`
	ReplacedSnssaiMappingList []SliceReplacementMapping `json:"replacedSnssaiMappingList,omitempty"`
	...
	DeregInactTimerList  *map[string]DeregInactTimerInfo `json:"deregInactTimerList,omitempty"`
	VoSupportMatchInd    *bool                           `json:"voSupportMatchInd,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _MmContext MmContext
...
func (o *MmContext) GetPartiallyAllowedNssai() []PartiallyAllowedSnssai {
	if o == nil || IsNil(o.PartiallyAllowedNssai) {
...
func (o *MmContext) GetReplacedSnssaiMappingList() []SliceReplacementMapping {
	if o == nil || IsNil(o.ReplacedSnssaiMappingList) {
...
func (o *MmContext) GetDeregInactTimerList() map[string]DeregInactTimerInfo {
	if o == nil || IsNil(o.DeregInactTimerList) {
...
func (o *MmContext) GetVoSupportMatchInd() bool {
	if o == nil || IsNil(o.VoSupportMatchInd) {
		var ret bool
		return ret
	}
...
func (o MmContext) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.PartiallyAllowedNssai) {
		toSerialize["partiallyAllowedNssai"] = o.PartiallyAllowedNssai
	}
	if !IsNil(o.ReplacedSnssaiMappingList) {
	...
	if !IsNil(o.DeregInactTimerList) {
		toSerialize["deregInactTimerList"] = o.DeregInactTimerList
	}
	if !IsNil(o.VoSupportMatchInd) {
