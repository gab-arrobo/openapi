...
var _ MappedNullable = &PrevSubInfo{}
...
func (o PrevSubInfo) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.NfAnaEvents) {
		toSerialize["nfAnaEvents"] = o.NfAnaEvents
	}
	if !IsNil(o.UeAnaEvents) {
