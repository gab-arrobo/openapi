...
type AmfEvent struct {
	...
	AdjustAoIOnRa                *bool           `json:"adjustAoIOnRa,omitempty"`
	RanTimingSynchroStatusChange *bool           `json:"ranTimingSynchroStatusChange,omitempty"`
	NotifyForSupiList            []string        `json:"notifyForSupiList,omitempty"`
	NotifyForGroupList           []string        `json:"notifyForGroupList,omitempty"`
	NotifyForSnssaiDnnList       []SnssaiDnnItem `json:"notifyForSnssaiDnnList,omitempty"`
	AdditionalProperties         map[string]interface{}
}

type _AmfEvent AmfEvent
...
func (o *AmfEvent) GetNextPeriodicReportTime() time.Time {
	if o == nil || IsNil(o.NextPeriodicReportTime) {
		var ret time.Time
		return ret
	}
...
func (o *AmfEvent) GetAdjustAoIOnRa() bool {
	if o == nil || IsNil(o.AdjustAoIOnRa) {
		var ret bool
		return ret
	}
...
func (o *AmfEvent) GetRanTimingSynchroStatusChange() bool {
	if o == nil || IsNil(o.RanTimingSynchroStatusChange) {
		var ret bool
		return ret
	}
...
func (o *AmfEvent) GetNotifyForSupiList() []string {
	if o == nil || IsNil(o.NotifyForSupiList) {
		var ret []string
		return ret
	}
...
func (o *AmfEvent) GetNotifyForGroupList() []string {
	if o == nil || IsNil(o.NotifyForGroupList) {
		var ret []string
		return ret
	}
...
func (o *AmfEvent) GetNotifyForSnssaiDnnList() []SnssaiDnnItem {
	if o == nil || IsNil(o.NotifyForSnssaiDnnList) {
