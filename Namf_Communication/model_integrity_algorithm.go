...
func (v *IntegrityAlgorithm) UnmarshalJSON(src []byte) error {
	...
	for _, existing := range AllowedIntegrityAlgorithmEnumValues {
	...
	return fmt.Errorf("%+v is not a valid IntegrityAlgorithm", value)
}
...
func NewIntegrityAlgorithmFromValue(v string) (*IntegrityAlgorithm, error) {
	...
	if ev.IsValid() {
		...
		return nil, fmt.Errorf("invalid value '%v' for IntegrityAlgorithm: valid values are %v", v, AllowedIntegrityAlgorithmEnumValues)
	}
}
