...
type EllipsoidArc struct {
	...
	UncertaintyRadius *float32 `json:"uncertaintyRadius,omitempty"`
...
func (o *EllipsoidArc) GetUncertaintyRadius() float32 {
	if o == nil || IsNil(o.UncertaintyRadius) {
		var ret float32
		return ret
	}
...
func (o *EllipsoidArc) GetIncludedAngle() int32 {
	if o == nil || IsNil(o.IncludedAngle) {
		var ret int32
		return ret
	}
