...
type Local2dPointUncertaintyEllipse struct {
	GADShape
	LocalOrigin        *LocalOrigin               `json:"localOrigin,omitempty"`
	Point              *RelativeCartesianLocation `json:"point,omitempty"`
